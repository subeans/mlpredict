...
Lenet5.add_layer('Average_pool', 'pool1', pool_size=2, padding='SAME', strides=2)
...
Lenet5.add_layer('Convolution', 'fc1', kernelsize=1, channels_out=120, 
                padding='SAME', strides=1, use_bias=1, activation='relu')
Lenet5.add_layer('Convolution', 'fc1', kernelsize=1, channels_out=84, 
                padding='SAME', strides=1, use_bias=1, activation='relu')
Lenet5.add_layer('Convolution', 'fc1', kernelsize=1, channels_out=10, 
